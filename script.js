document.addEventListener('DOMContentLoaded', function() {
    ...
    function flipCard(index) {
        ...
        cardElement.setAttribute('data-number', cards[index]);
        ...
        if (flippedCards.length === 2) {
            ...
            if (cards[first] === cards[second]) {
                ...
                setTimeout(() => {
                    ...
                    document.querySelector(`.memory-card[data-index="${first}"]`).removeAttribute('data-number');
                    document.querySelector(`.memory-card[data-index="${second}"]`).removeAttribute('data-number');
                    flippedCards = [];
                    isLocked = false;
                }, 1000);
            }
